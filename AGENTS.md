...
- 当前基线：M1 工程闭环、M2 consent-bound 窄只读源工程、M3a Runtime、M3b Markdown projection 和 TRACE 证据闭环已完成；M2 pilot evidence tooling 已准备但真实 pilot 仍 `NOT_RUN`。最新 readonly revoke 竞态修复提交为 `def3be9`，全量 fork 单测 160/160、双视口 E2E 32/32 通过。
