...
const behaviorEventSchema: z.ZodType<BehaviorEvent> = z.object({
  ...
  source: z.union([
    ...
    z.object({ kind: z.literal('json-import'), importBatchId: safeString, sourceItemKey: safeString, adapterId: safeString, adapterVersion: safeString, consentId: safeString.optional(), policyVersion: safeString.optional(), purpose: safeString.optional() }).strict(),
